...
public class ThrustCopterChap3 extends ApplicationAdapter {
    SpriteBatch batch;
    FPSLogger fpsLogger;
    ...
    public void create() {
        ...
        //atlas = new TextureAtlas(Gdx.files.internal("ThrustCopterChap3.pack"));
        ...
        gameOver = new Texture("core/assets/gameover.png");
        ...
        music = Gdx.audio.newMusic(Gdx.files.internal("core/assets/sounds/journey.mp3"));
        music.setLooping(true);
        music.play();

        tapSound = Gdx.audio.newSound(Gdx.files.internal("core/assets/sounds/pop.ogg"));
        crashSound = Gdx.audio.newSound(Gdx.files.internal("core/assets/sounds/crash.ogg"));
        spawnSound = Gdx.audio.newSound(Gdx.files.internal("core/assets/sounds/alarm.ogg"));
